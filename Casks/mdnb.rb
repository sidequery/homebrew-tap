cask "mdnb" do
  version "0.2.9,13"
  sha256 "b65722be9d54c83c77586b9822982890aa17b6593ae6543458ce40be76485f8e"
  asset_id = 354821401
  ...
  if token
    ...
    url "https://github.com/sidequery/homebrew-tap/releases/download/mdnb-0.2.9-13/mdnb-0.2.9-13-macos14.0-arm64.zip",
        verified: "github.com/sidequery/homebrew-tap/"
  end
