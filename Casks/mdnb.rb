cask "mdnb" do
  version "0.8.4,46"
  sha256 "d7429e177500541bf5c2d718c27e80aaed17d7fdc9cf7d3f36463f189452e9a6"
  asset_id = 401738198
  ...
  if token
    ...
    url "https://github.com/sidequery/homebrew-tap/releases/download/mdnb-0.8.4-46/mdnb-0.8.4-46-macos15.0-arm64.zip",
        verified: "github.com/sidequery/homebrew-tap/"
  end
